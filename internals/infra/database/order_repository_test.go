...
func (suite *OrderRepositoryTestSuite) TestFindAll_ShouldReturnAllOrders() {
	...
	// Verificar se o número correto de ordens foi retornado
	suite.NotEqual(0, len(orders))

	// Verificar se as ordens retornadas correspondem às esperadas
	suite.ElementsMatch([]entity.Order{*order1, *order2}, orders)
}
